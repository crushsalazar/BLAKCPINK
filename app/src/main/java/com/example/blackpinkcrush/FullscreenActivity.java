package com.example.blackpinkcrush;
...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress=  new ProgressDialog(FullscreenActivity.this);
        ...
        handlerr.postDelayed(new Runnable() {
            public void run() {
                Intent i= new Intent(FullscreenActivity.this, JUEGOS.class);
                startActivity(i);
